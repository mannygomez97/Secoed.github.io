!function(s){
	...
	e.prototype.init=function(){
		s(".select2").select2(),s(".select2-limiting")
		.select2({maximumSelectionLength:2}),s(".select2-search-disable")
		.select2({minimumResultsForSearch:1/0}),s(".select2-ajax")
		.select2({
			ajax:{
				...
				{results:e.items,pagination:{more:30*t.page<e.total_count}}},
				cache:!0},
				...
				templateResult:function(e){
					...
					return t.find(".select2-result-repository__title").text(e.full_name),
					...
					t.find(".select2-result-repository__watchers").append(e.watchers_count+" Watchers"),t},
					templateSelection:function(e){return e.full_name||e.text}
				}),
		s(".select2-templating")
		.select2({
			templateResult:function(e){
