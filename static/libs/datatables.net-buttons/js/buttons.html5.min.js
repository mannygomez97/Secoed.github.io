(function (j) {
    ...
    function L(a, b) {
        ...
        for (var e = 0, g = a.body.length; e < g; e++) if (c = a.body[e][b], c = null !== c && c !== o ? c.toString() : "", -1 !== c.indexOf("\n") ? (c = c.split("\n"), c.sort(function (a, c) {
    ...
    if ("undefined" === typeof h || "undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)) u = void 0; else {
        var y = h.document.createElementNS("http://www.w3.org/1999/xhtml", "a"), M = "download" in y,
            N = /constructor/i.test(h.HTMLElement) || h.safari, C = /CriOS\/[\d]+/.test(navigator.userAgent),
            O = function (a) {
                ...
                d || (a = E(a));
                var c = this, d = "application/octet-stream" === a.type, e, g = function () {
        ...
        }, l.readyState = l.INIT = 0, l.WRITING = 1, l.DONE = 2, l.error = l.onwritestart = l.onprogress = l.onwrite = l.onabort = l.onerror = l.onwriteend = null, u = function (a, b, d) {
    ...
    var G = function (a) {
        ...
        for (var d = H(b), c = a.buttons.exportData(b.exportOptions), e = b.fieldBoundary, g = b.fieldSeparator, j = RegExp(e, "g"), i = b.escapeChar !== o ? b.escapeChar : "\\", f = function (a) {
            ...
            return c
        }, h = b.header ? f(c.header) + d : "", k = b.footer && c.footer ? d + f(c.footer) : "", n = [], m = 0, l = c.body.length; m <
    ...
    try {
        var z = new XMLSerializer, s
    } catch (P) {
    }
    var B = {
            "_rels/.rels": '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Tipo="http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="xl/workbook.xml"/></Relationships>',
            "xl/_rels/workbook.xml.rels": '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Tipo="http://schemas.openxmlformats.org/officeDocument/2006/relationships/worksheet" Target="worksheets/sheet1.xml"/><Relationship Id="rId2" Tipo="http://schemas.openxmlformats.org/officeDocument/2006/relationships/styles" Target="styles.xml"/></Relationships>',
    ...
    q.ext.buttons.copyHtml5 = {
        ...
        action: function (a, b, d, c) {
            this.processing(!0);
            var e = this, a = I(b, c), g = b.buttons.exportInfo(c), f = H(c), i = a.str,
            ...
            c[0].focus();
            c[0].select();
            var l = j(h).closest(".dt-button-info"), o = function () {
    ...
    q.ext.buttons.csvHtml5 = {
        ...
        action: function (a, b, d, c) {
            this.processing(!0);
            var a = I(b, c).str, d = b.buttons.exportInfo(c), e = c.charset;
    ...
    q.ext.buttons.excelHtml5 = {
        ...
        action: function (a, b, d, c) {
            this.processing(!0);
            var e = this, g = 0, h, a = function (a) {
                return j.parseXML(B[a])
            }, i = a("xl/worksheets/sheet1.xml"), l = i.getElementsByTagName("sheetData")[0], a = {
            ...
            }, k = b.buttons.exportData(c.exportOptions), q, r, m = function (a) {
                q = g + 1;
                r = n(i, "row",
                    {attr: {r: q}});
            ...
            c.autoFilter && (j("mergeCells", i).before(n(i, "autoFilter", {attr: {ref: "A" + d + ":" + x(k.header.length - 1) + h}})), j("definedNames", m).append(n(m, "definedName", {
                attr: {
    ...
    q.ext.buttons.pdfHtml5 = {
        ...
        action: function (a, b, d, c) {
            this.processing(!0);
            var d = b.buttons.exportData(c.exportOptions), a = b.buttons.exportInfo(c), e = [];
