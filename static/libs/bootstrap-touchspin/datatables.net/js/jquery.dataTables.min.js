...
(function (h) {
    ...
    function tb(a) {
        ...
        var b = i.children(), k = b[0], f = b[1], r = m ? b[2] : null;
    ...
    function ma(a) {
        var b = a.oScroll, c = b.sX, d = b.sXInner, e = b.sY, b = b.iBarWidth, f = h(a.nScrollHead), g = f[0].style,
            ...
            n = j.children("table"), j = a.nScrollBody, m = h(j), q = j.style, r = h(a.nScrollFoot).children("div"),
            l = r.children("table"), o = h(a.nTHead), p = h(a.nTable), s = p[0], u = s.style,
            t = a.nTFoot ? h(a.nTFoot) : null, U = a.oBrowser, V = U.bScrollOversize, $b = C(a.aoColumns, "nTh"), Q, L,
    ...
    function Ha(a) {
        var b = a.nTable, c = a.aoColumns, d = a.oScroll, e = d.sY, f = d.sX, g = d.sXInner, j = c.length,
            i = na(a, "bVisible"), n = h("th", a.nTHead), m = b.getAttribute("width"), k = b.parentNode, r = !1, l, o,
        ...
        if (d || !r && !f && !e && j == W(a) && j == n.length) for (l = 0; l < j; l++) i = ba(a, l),
    ...
    h.extend(s.prototype, {
        ...
        splice: x.splice, toArray: function () {
    ...
    o("cells()", function (a, b, c) {
        ...
        if (b === null || b === k) return this.iterator("table", function (b) {
            var d = a, e = cb(c), f = b.aoData, g = Da(b, e), i = Sb(ka(f, g, "anCells")), j = h(Tb([], i)), l,
                n = b.aoColumns.length, o, t, s, u, w, v;
    ...
    o("destroy()", function (a) {
        ...
        return this.iterator("table", function (b) {
            var c = b.nTableWrapper.parentNode, d = b.oClasses,
                e = b.nTable, f = b.nTBody, g = b.nTHead, j = b.nTFoot, i = h(e), f = h(f), k = h(b.nTableWrapper),
    ...
    l.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "Mostrando _START_ - _END_ de _TOTAL_ datos",
            sInfoEmpty: "Mostrando 0 - 0 de 0 datos",
            sInfoFiltered: "(filtered from _MAX_ total entries)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Mostrando _MENU_ datos",
