...
!function (d) {
    ...
    a.DEFAULTS = {
        ...
        var t, i = this, e = 0, o = i.$table.offset().top, a = d(this.options.mainContainer).scrollTop() - 1,
        ...
        if (t = this.options.mainContainer === window ? o < a && a < o + i.$table.height() : o <= 0 && -o < i.$table.height(), i.useFixedSolution) {
            ...
            (e = this.options.mainContainer === window ? a - o - 1 : -o - 1) < 0 ? e = 0 : s < e && (e = s), this.options.mainContainer === window && 0 < n && (e -= n), t ? (i.$stickyTableHeader.css({visibility: "visible"}), i.$stickyTableHeader.animate({top: e + "px"}, 400), i.$thead.css({visibility: "hidden"})) : i.$stickyTableHeader.animate({top: "0"}, 400, function () {
        ...
        n.$hdrCells.each(function (t) {
            var i = d(this), e = i.prop("id"), o = i.text();
        ...
        if (!t.data("setup")) {
            ...
            t.find("th, td").each(function () {
                var t = d(this), i = "", e = t.prop("colSpan");
    ...
    d.fn.responsiveTable = function (o) {
        return this.each(function () {
            var t = d(this), i = t.data("responsiveTable"),
